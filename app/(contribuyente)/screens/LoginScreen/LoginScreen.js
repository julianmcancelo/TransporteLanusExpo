// =================================================================
// src/screens/LoginScreen/LoginScreen.js - v7.7 (Login de Uso Interno)
// =================================================================
...
// --- Iconos SVG ---
const QRIcon = ({ color }) => <Svg width={24} height={24} viewBox="0 0 24 24" fill="none"><Path d="M4 4h4v4H4zM4 16h4v4H4zM16 4h4v4h-4zM16 16h4v4h-4zM10 6h4M6 10h2M6 14h2M10 12h2M10 18h4M16 10h2M16 14h2" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" /></Svg>;
const IdCardIcon = ({ color }) => <Svg width={24} height={24} viewBox="0 0 24 24" fill="none"><Path d="M22 10.5V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12a2 2 0 002 2h8" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" /><Path d="M2 7h20M18 19a3 3 0 100-6 3 3 0 000 6zM15 22a3 3 0 003-3 3 3 0 00-3-3" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" /></Svg>;
const BackIcon = ({ color }) => <Svg width={24} height={24} viewBox="0 0 24 24" fill="none"><Path d="M19 12H5M12 19l-7-7 7-7" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"/></Svg>;
const UserIcon = ({ color }) => <Svg width={20} height={20} viewBox="0 0 24 24" fill="none"><Path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"/><Path d="M12 11a4 4 0 100-8 4 4 0 000 8z" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"/></Svg>;
const LicenseIcon = ({ color }) => <Svg width={20} height={20} viewBox="0 0 24 24" fill="none"><Path d="M15 2H9C4 2 2 4 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7V9c0-5-2-7-7-7z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><Path d="M15.997 12h.01M11.995 12h.01M7.995 12h.01" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"/></Svg>;
const InfoIcon = ({ color }) => <Svg width={24} height={24} viewBox="0 0 24 24" fill="none"><Path d="M12 22a10 10 0 100-20 10 10 0 000 20zM12 16v-4m0-8h.01" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" /></Svg>;
const MailIcon = ({ color }) => <Svg width={20} height={20} viewBox="0 0 24 24" fill="none"><Path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><Path d="M22 6l-10 7L2 6" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></Svg>;
const LinkedInIcon = ({ color }) => <Svg width={20} height={20} viewBox="0 0 24 24" fill="none"><Path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><Rect x="2" y="9" width="4" height="12" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><Circle cx="4" cy="4" r="2" fill={color}/></Svg>;
const PortfolioIcon = ({ color }) => <Svg width={20} height={20} viewBox="0 0 24 24" fill="none"><Circle cx="12" cy="12" r="10" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><Path d="M2 12h20M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></Svg>;
// **USO INTERNO**: Nuevo ícono y campos de formulario
const ShieldIcon = ({ color }) => <Svg width={24} height={24} viewBox="0 0 24 24" fill="none"><Path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"/></Svg>;
const KeyIcon = ({ color }) => <Svg width={20} height={20} viewBox="0 0 24 24" fill="none"><Path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 11-7.778 7.778 5.5 5.5 0 017.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 7.5L9 12" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></Svg>;
const AtSignIcon = ({ color }) => <Svg width={20} height={20} viewBox="0 0 24 24" fill="none"><Circle cx="12" cy="12" r="4" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><Path d="M16 8v5a3 3 0 006 0v-1a10 10 0 10-3.92 7.94" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></Svg>;

// --- Componentes de UI (Sin cambios) ---
const AnimatedShape = ({ style, delay }) => {
    const anim = useRef(new Animated.Value(0)).current;
    useEffect(() => {
        Animated.loop(
            Animated.timing(anim, { toValue: 1, duration: 15000 + delay, easing: Easing.linear, useNativeDriver: true })
        ).start();
    }, []);
...
const AnimatedHeaderBackground = ({ themeColors }) => {
...
const ContactModal = ({ visible, onClose, themeColors }) => {
    const styles = getStyles(themeColors);
    const modalAnim = useRef(new Animated.Value(0)).current;
    const handleLink = (url) => Linking.openURL(url).catch(() => Alert.alert("Error", "No se puede abrir el enlace."));

    useEffect(() => {
        if (visible) {
            Animated.spring(modalAnim, { toValue: 1, friction: 8, tension: 60, useNativeDriver: true }).start();
        } else {
            Animated.timing(modalAnim, { toValue: 0, duration: 300, easing: Easing.out(Easing.ease), useNativeDriver: true }).start();
        }
    }, [visible]);
            ...
            <Pressable style={styles.modalOverlay} onPress={onClose}>
                <Animated.View style={[styles.modalContainer, { transform: [{ translateY: modalTranslateY }] }]}>
                    ...
                    <View style={styles.profileImageContainer}>
                        <Image source={{ uri: `https://placehold.co/100x100/0093D2/FFFFFF?text=JC` }} style={styles.profileImage} />
                    </View>
                    <Text style={styles.profileName}>Julian Cancelo</Text>
                    <Text style={styles.profileRole}>Full-Stack Developer</Text>
                    <Text style={styles.profileDescription}>
                        Desarrollador con experiencia en la creación de aplicaciones móviles y web. Apasionado por las tecnologías modernas y la creación de experiencias de usuario intuitivas y eficientes.
                    </Text>
                    <View style={styles.contactButtonContainer}>
                        <Pressable style={({pressed}) => [styles.contactButton, pressed && styles.contactButtonPressed]} onPress={() => handleLink('mailto:julian.cancelo@example.com')}>
                            <MailIcon color={themeColors.primary} />
                            <Text style={styles.contactButtonText}>Email</Text>
                        </Pressable>
                        <Pressable style={({pressed}) => [styles.contactButton, pressed && styles.contactButtonPressed]} onPress={() => handleLink('https://www.linkedin.com/')}>
                            <LinkedInIcon color={themeColors.primary} />
                            <Text style={styles.contactButtonText}>LinkedIn</Text>
                        </Pressable>
                        <Pressable style={({pressed}) => [styles.contactButton, pressed && styles.contactButtonPressed]} onPress={() => handleLink('https://example.com')}>
                            <PortfolioIcon color={themeColors.primary} />
                            <Text style={styles.contactButtonText}>Portfolio</Text>
                        </Pressable>
                    </View>
                </Animated.View>
            </Pressable>
...
const InputWithIcon = ({ icon, themeColors, ...props }) => {
    const styles = getStyles(themeColors);
    return (
        <View style={styles.inputContainer}>
            <View style={styles.inputIcon}>{icon}</View>
            <TextInput style={styles.input} placeholderTextColor={themeColors.grayMedium} {...props} />
        </View>
    );
};

const ActionCard = ({ icon, title, subtitle, onPress, delay, disabled, themeColors }) => {
    const styles = getStyles(themeColors);
    ...
    return (
        <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
            <TouchableOpacity style={[styles.actionCard, disabled && styles.disabledCard]} onPress={onPress} disabled={disabled}>
...
const LoginScreen = () => {
    ...
    const AppColors = {
        light: {
            ...Colors.light, primary: '#0093D2', primaryDark: '#007AB8', background: '#FFFFFF',
            card: '#F7F9FC', text: '#1C1C1E', border: '#E8E8E8', grayMedium: '#8A8A8E',
        },
        dark: {
            ...Colors.dark, primary: '#0093D2', primaryDark: '#007AB8', background: '#121212',
            card: '#1E1E1E', text: '#E5E5E7', border: '#2D2D2F', grayMedium: '#98989D',
        }
    };
    ...
    // **USO INTERNO**: Añadimos 'internal' al estado de viewMode
    const { error, signOut, signInWithManual, signInWithInternal, isLoading } = useAuth();
    const [viewMode, setViewMode] = useState('choice'); 
    
    // Estados para los formularios
    const [licencia, setLicencia] = useState('');
    const [dni, setDni] = useState('');
    const [identifier, setIdentifier] = useState(''); // Para Email o Legajo
    ...
    useEffect(() => {
        // La animación de entrada solo se ejecuta si estamos en la vista 'choice'
        if (viewMode === 'choice') {
            logoAnim.setValue(0);
    ...
    const handleManualLogin = () => {
        if (!licencia.trim() || !dni.trim()) {
            Alert.alert("Campos incompletos", "Por favor, ingrese su DNI y N° de Licencia.");
            return;
        }
        signInWithManual(licencia, dni);
    };

    // **USO INTERNO**: Nueva función para manejar el login interno
    const handleInternalLogin = () => {
        if (!identifier.trim() || !password.trim()) {
            Alert.alert("Campos incompletos", "Por favor, ingrese su email/legajo y contraseña.");
            return;
        }
        // Debes crear esta función `signInWithInternal` en tu AuthContext
        signInWithInternal(identifier, password); 
    };
    
    // **USO INTERNO**: Lógica de transición actualizada
    const changeView = (newView) => {
        setViewMode(newView);
        const toValue = newView === 'choice' ? 0 : 1;
        const duration = newView === 'choice' ? 600 : 500;
        const easing = newView === 'choice' 
            ...
            <LinearGradient colors={[themeColors.primary, themeColors.primaryDark]} style={styles.gradientContainer}>
                ...
                <SafeAreaView style={{ flex: 1 }}>
                    ...
                    <View style={styles.formContainer}>
                        <ActionCard icon={<IdCardIcon color={themeColors.primary} />} title="Ingresar con DNI y Licencia" subtitle="Acceso para conductores habilitados" onPress={() => changeView('manual')} delay={200} disabled={false} themeColors={themeColors} />
                        {/* **USO INTERNO**: Nueva tarjeta de acción */}
                        ...
                        <ActionCard icon={<QRIcon color={themeColors.primary} />} title="Ingresar con QR" subtitle="Función próximamente disponible" onPress={() => {}} delay={400} disabled={true} themeColors={themeColors} />
                    </View>
                </SafeAreaView>
            </LinearGradient>
        </Animated.View>
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
                <View style={styles.manualFormContent}>
                    <View style={styles.manualHeader}>
                        ...
                        <Text style={styles.manualTitle}>Ingreso de Conductor</Text>
                        <Text style={styles.manualSubtitle}>Complete los campos para acceder a su panel.</Text>
                    </View>
...
// --- Estilos Dinámicos (Sin cambios, ya son adaptativos) ---
const getStyles = (colors) => StyleSheet.create({
    ...
    headerContainer: { 
        flex: 0.55, justifyContent: 'space-between', paddingHorizontal: 24, 
        paddingTop: Platform.OS === 'android' ? 20 : 0, paddingBottom: 40, 
    },
    headerContent: {
        flex: 1, justifyContent: 'center', alignItems: 'center',
    },
    logo: { width: 160, height: 160, marginBottom: 24 }, // Ajustado para más tarjetas
    ...
    formContainer: { 
        ...
        paddingTop: 30, paddingBottom: 20, paddingHorizontal: 24, zIndex: 1, 
        shadowColor: '#000', shadowOffset: { width: 0, height: -10 }, 
        shadowOpacity: colors.background === '#121212' ? 0.2 : 0.05, shadowRadius: 20, elevation: 20 
    },
    actionCard: { 
    ...
    inputContainer: { 
        ...
        width: '100%', height: 55, marginBottom: 16 
    },
    ...
    modalContainer: { 
        ...
        paddingHorizontal: 24, paddingTop: 12, paddingBottom: Platform.OS === 'ios' ? 40 : 24, alignItems: 'center' 
    },
