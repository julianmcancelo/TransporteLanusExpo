// =================================================================
// src/screens/LoginScreen/LoginScreen.js - v9.0 (Versión Final y Funcional)
// =================================================================
...
const ActionCard = React.memo(({ icon, title, subtitle, onPress, delay, disabled, themeColors }) => {
    const styles = getStyles(themeColors);
...
const LoginScreen = () => {
    ...
    const handleInternalLogin = () => {
        if (!identifier.trim() || !password.trim()) { Alert.alert("Campos incompletos", "Por favor, ingrese su email/legajo y contraseña."); return; }
            ...
            <LinearGradient colors={[themeColors.primary, themeColors.primaryDark]} style={styles.gradientContainer}>
                ...
                <SafeAreaView style={{ flex: 1 }}>
                    ...
                    <View style={styles.formContainer}>
                        ...
                        <ActionCard icon={<ShieldIcon color={themeColors.primary} />} title="Uso Interno" subtitle="Acceso para personal autorizado" onPress={() => changeView('internal')} delay={300} disabled={isLoading} themeColors={themeColors} />
                        <ActionCard 
